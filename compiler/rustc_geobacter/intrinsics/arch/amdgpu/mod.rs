...
impl mir::CustomIntrinsicMirGen for DispatchPtr {
    ...
    {
        let _ = span!(Event::Debug, "mirgen intrinsic {}", self).enter();
...
impl fmt::Display for DispatchPtr {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(f, "geobacter_amdgpu_dispatch_ptr")
    }
}
...
impl fmt::Display for Barrier {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(f, "geobacter_amdgpu_barrier")
    }
}
...
impl fmt::Display for WaveBarrier {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(f, "geobacter_amdgpu_wave_barrier")
    }
}
