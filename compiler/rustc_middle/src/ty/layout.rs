...
impl<'tcx> LayoutCx<'tcx, TyCtxt<'tcx>> {
    ...
    fn generator_layout(
        ...
        debug!("prefix_layouts = {:#?}, promoted_start = {}", prefix_layouts, tag_index + 1);
        let promoted_layouts = &prefix_layouts[tag_index + 1..];
            ...
            Variants::Single { index } => {
                ...
                tcx.intern_layout(Layout {
                    ...
                    fields: match NonZeroUsize::new(fields) {
                        ...
                        None => FieldsShape::Arbitrary { offsets: vec![], memory_index: vec![], padded_indices: None, },
                    },
                    abi: Abi::Uninhabited,
                    largest_niche: None,
