...
extern "C" {
    ...
    pub fn LLVMRustGetMDKindID(C: &Context, Str: *const c_char) -> c_uint;
    ...
    pub fn LLVMRustGlobalObjectSetMetadata(GO: &'a Value, KindID: c_uint,
                                           Node: &'a Value);
    ...
    pub fn LLVMRustBuildScopedAtomicFence(
        B: &Builder<'_>,
        Order: AtomicOrdering,
        Scope: *const c_char,
        ScopeLen: c_uint
