...
impl ReadFirstLane for i8 {
    ...
    unsafe fn read_first_lane(self) -> Self {
        ...
        let v: u8 = geobacter_amdgpu_readfirstlane(v as _) as _;
...
impl ReadFirstLane for i16 {
    ...
    unsafe fn read_first_lane(self) -> Self {
        ...
        let v: u16 = geobacter_amdgpu_readfirstlane(v as _) as _;
        crate::mem::transmute(v)
    }
}
impl ReadFirstLane for i32 {
    ...
    unsafe fn read_first_lane(self) -> Self {
        ...
        let v = geobacter_amdgpu_readfirstlane(v);
        crate::mem::transmute(v)
    }
}
...
impl ReadFirstLane for u32 {
    #[inline(always)]
    unsafe fn read_first_lane(self) -> Self {
        geobacter_amdgpu_readfirstlane(self)
    }
}
#[cfg(target_pointer_width = "32")]
